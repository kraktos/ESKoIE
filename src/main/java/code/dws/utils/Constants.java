...
public class Constants {
	...
	public static final String GET_SF = "select r1.SF, r2.SF from wikiPrep as r1 cross join wikiPrep as r2 where r1.URI=? and r2.URI=? and r1.COUNT > 1 and r2.COUNT > 1";

	public static final String INSERT_GS_PROP = "INSERT IGNORE INTO OIE_PROP_GS(PHRASE, KB_PROP,EVAL, INV) VALUES (?,?,?,?)";
