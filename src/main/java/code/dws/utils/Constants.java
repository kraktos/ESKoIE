...
public class Constants
{
    ...
    public static final String GET_SF =
        "select r1.SF, r2.SF from (select SF from wikiPrep where URI=? order by COUNT DESC limit 15) as r1 cross join (select SF from wikiPrep where URI =? order by COUNT DESC limit 15) as r2";
    ...
    public static final String GET_ANNO_PROPERTIES =
        "SELECT PHRASE, KB_PROP, EVAL, INV FROM OIE_PROP_GS where EVAL = '' limit 1;";
